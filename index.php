        ...
        <div class="fb-home-timeline-area">
            <div class="fb-home-timeline">
                ...
                <?php
                     ...
                     * Get All Data
                     */
                    $posts = array_reverse(json_decode(file_get_contents("./db/posts.json")), false);
        ...
        ?>
                ...
                <div class="user-post">
                    <div class="user-post-header">
                        <div class="post-info">
                            <img src="./media/profile-photo/<?php echo $post -> user_photo ;?>" alt="" />
                    ...
                    <div class="post-media">
                        <img src="media/photos/<?php echo $post -> post_photos[0] ;?>" alt="" />
                    </div>
                    <?php endif ;?>
    ...
    <?php
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["post_submit"] == "Post") {
                ...
                if (empty($user_name) || !$_FILES["post_user_photo"]["name"]) {
                    echo req_alert("Auth User Not Found", "danger");
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="form-data-modal">
                        <form action="<?php echo $_SERVER["PHP_SELF"] ;?>" method="POST" enctype="multipart/form-data">

                            <div class="my-2">
                                <label for="">Auth User Name</label>
                                <input type="text" class="form-control my-2" name="post_user_name" value="">
                            </div>

                            <div class="my-2">
                                <label for="">Auth User Photo</label>
                                <input type="file" class="form-control my-2" name="post_user_photo" value="">
                            </div>

                            <div class="my-2">
                                <label for="">Post Content</label>
                                <textarea class="form-control my-2" name="post_content" id=""></textarea>
                            </div>

                            <div class="my-2">
                                <label for="">Post Image</label>
                                <input type="file" multiple class="form-control my-2" name="post_photos[]">
                            </div>

                            <div class="my-2">
                                <label for="">Post Video</label>
                                <input type="file" class="form-control my-2" name="post_video">
                            </div>

                            <div class="my-2">
                                <input type="submit" class="btn btn-primary d-block w-100 my-2" name="post_submit"
                                    value="Post">
                            </div>
                ...
                <div class="modal-body">
                    ...
                    <form action="">
                        ...
                        <div class="my-2">
                            ...
                            <textarea class="form-control" name="com_content" id=""></textarea>
                        </div>
